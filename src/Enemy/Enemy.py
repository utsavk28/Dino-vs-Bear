...
class Enemy():
    def __init__(self, sprite_path, pos, scale=1):
        ...
        self.pos = Position(pos, (32, 32), scale)
    ...
    def update(self,player_pos):
        ...
        self.sprite_manager.update(pos=self.pos.pos, new_state=newState,direction=self.direction,health_percent=self.stats.health_percent)
        # print(self.move_state_machine.current_state)
        # print(self.pos.velocity)
        # print(self.behavior_state_machine.current_state)
